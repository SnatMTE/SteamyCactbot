...
A Cactbot overlay integration plugin for Final Fantasy XIV, built with Dalamud.

## Overview

CactbotUI connects to the [OverlayPlugin](https://github.com/ngld/OverlayPlugin) WebSocket server to display raidboss alerts, triggers, and timelines directly in-game through a lightweight overlay window.
